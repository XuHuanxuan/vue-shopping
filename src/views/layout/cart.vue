    ...
    <div class="cart-box" v-if="isLogin && cartList.length > 0">
      ...
      <div class="cart-list">
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          <van-checkbox @click="toggleCheck(item.goods_id)" :value="item.isChecked" class="checkbox"></van-checkbox>
          <div class="show">
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <van-stepper @change="(value) => changeCount(value, item.goods_id, item.goods_sku_id)"
                :value="item.goods_num" min="1" integer />
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-if="!isEdit" @click="goPay" class="goPay" :class="{ disabled: selCount === 0 }">结算({{ selCount }})
          </div>
...
export default {
  ...
  methods: {
    ...
    changeCount (value, goodsId, skuId) {
      // console.log(goodsNum, goodsId, skuId)
